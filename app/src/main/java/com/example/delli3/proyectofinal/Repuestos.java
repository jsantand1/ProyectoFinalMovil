...
public class Repuestos extends AppCompatActivity implements AdaptadorProductos.OnProductosClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showToolbar(getResources().getString(R.string.Mis_Repuestos),true);



        lstventas = findViewById(R.id.lstVentas);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    for(DataSnapshot snapshot:dataSnapshot.getChildren()){
                        ...
                        if(user.getUid().equals(p.provedor)) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_ventas);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =  new Intent(Repuestos.this, registar_productos.class);
